...
class Program
{
    static void Main()
    {
        ...
        // Print
        Console.WriteLine("The Sum of {0} and {1} is {2}", num1, num2, numResult); // changed Write → WriteLine
        ...
        Console.WriteLine("Payable amount after discount :{0}", numResult - disc); // fixed
